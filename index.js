// shiva8x@gmail.com - 20190127 - 1.0.0
// const lbl = require('line-by-line')
// const reader = new lbl('./temp/data.txt', { encoding: 'utf8', skipEmptyLines: true })
// const fs = require('fs');
// const filePath = fs.createWriteStream('./output/finished.xls');
...
reader.on('end', function() {
    console.log("All lines were read. Number of lines: " + lines.length)
    // write to file
